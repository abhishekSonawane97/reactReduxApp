...
import { addItems, deleteItems } from '../Slices/Thalislice'
  ...
  <div className="col-sm-6">
    <div className="card">
      <div className="card-body">
        ...
        <button className="btn btn-danger m-2" onClick={()=>dispatch(deleteItems(menu[0]))}>Remove</button>
        <p>₹ - 12 /-</p>
      </div>
    </div>
  </div>
  <div className="col-sm-6">
    <div className="card">
      <div className="card-body">
        ...
        <button className="btn btn-danger m-2" onClick={()=>dispatch(deleteItems(menu[1]))}>Remove</button>
        <p>₹ - 130 /-</p>
      </div>
    </div>
  </div>
  ...
  <div className="col-sm-6">
    <div className="card">
      <div className="card-body">
        ...
        <button className="btn btn-danger m-2" onClick={()=>dispatch(deleteItems(menu[2]))}>Remove</button>
        <p>₹ - 120 /- </p>
      </div>
    </div>
  </div>
  <div className="col-sm-6">
    <div className="card">
      <div className="card-body">
        ...
        <button className="btn btn-danger m-2" onClick={()=>dispatch(deleteItems(menu[3]))}>Remove</button>
        <p>₹ - 80 /-</p>
      </div>
    </div>
  </div>
    ...
    <div className="card">
      <div className="card-body">
        ...
        <button className="btn btn-danger m-2" onClick={()=>dispatch(deleteItems(menu[4]))}>Remove</button>
  ...
  <div className="col-sm-6">
    <div className="card">
      <div className="card-body">
        ...
        <button className="btn btn-danger m-2" onClick={()=>dispatch(deleteItems(menu[5]))}>Remove</button>
        <p>₹ - 90 /-</p>
      </div>
    </div>
  </div>
  ...
  <div className="col-sm-6">
    <div className="card">
      <div className="card-body">
        ...
        <button className="btn btn-danger m-2" onClick={()=>dispatch(deleteItems(menu[6]))}>Remove</button>
        <p>₹ - 200 /-</p>
      </div>
    </div>
  </div>
  <div className="col-sm-6">
    <div className="card">
      <div className="card-body">
        ...
        <button className="btn btn-danger m-2" onClick={()=>dispatch(deleteItems(menu[7]))}>Remove</button>
        <p>₹ - 180 /-</p>
      </div>
    </div>
  </div>
